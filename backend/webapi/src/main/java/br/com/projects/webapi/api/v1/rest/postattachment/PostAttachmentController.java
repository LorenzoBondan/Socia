package br.com.projects.webapi.api.v1.rest.postattachment;
...
public class PostAttachmentController {
    ...
    public PostAttachmentController(PostAttachmentService service) {
     ...
     */
    @Operation(summary = "Search a PostAttachment by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param codes list of PostAttachment codes to be deleted
     */
    @Operation(summary = "Delete a list of PostAttachments", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
