package br.com.projects.webapi.api.v1.rest.userattachment;
...
public class UserAttachmentController {
    ...
    public UserAttachmentController(UserAttachmentService service) {
     ...
     */
    @Operation(summary = "Search a UserAttachment by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param codes list of UserAttachment codes to be deleted
     */
    @Operation(summary = "Delete a list of UserAttachments", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
