package br.com.projects.webapi.api.v1.rest.postlike;
...
public class PostLikeController {
    ...
    /**
     * @param id represents the ID of the PostLike to be searched
     */
    @Operation(summary = "Search a PostLike by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    /**
     * @param dto represents the PostLike object to be created
     */
    @Operation(summary = "Insert a new PostLike", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            @RequestBody
            @Schema(
                    description = "PostLike object for creation",
                    requiredProperties = "post.id, user.id",
                    example = """
                    {
                        "post": {
                            "id": 1
    ...
    /**
     * @param codes list of PostLike codes to be deleted
     */
    @Operation(summary = "Delete a list of PostLikes", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
