package br.com.projects.webapi.api.v1.rest.comment;
...
public class CommentController {
     ...
     */
    @Operation(summary = "Search a Comment by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
     ...
     */
    @Operation(summary = "Insert a new Comment", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            ...
            @Schema(
                    ...
                    requiredProperties = "post.id, user.id, description, date",
                    example = """
                    {
                        "post": {
                            "id": 1
    ...
    public ResponseEntity<?> update(
            ...
            @Schema(
                    ...
                    requiredProperties = "id, post.id, user.id, description, date",
                    example = """
                    {
                        "id": 1,
                        "post": {
    ...
    /**
     * @param codes list of Comment codes to be deleted
     */
    @Operation(summary = "Delete a list of Comments", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
