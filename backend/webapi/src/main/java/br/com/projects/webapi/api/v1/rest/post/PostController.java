package br.com.projects.webapi.api.v1.rest.post;
...
public class PostController {
     ...
     */
    @Operation(summary = "Search a Post by id", method = "GET", description = "Search an object by id, regardless of its status")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> create(
            ...
            @Schema(
                    ...
                    requiredProperties = "userAuthor.id, description, date",
                    example = """
                    {
                        "userAuthor": {
                            "id": 1
    ...
    public ResponseEntity<?> update(
            ...
            @Schema(
                    ...
                    requiredProperties = "id, userAuthor.id, description, date",
                    example = """
                    {
                        "id": 1,
                        "userAuthor": {
    ...
    /**
     * @param codes list of Post codes to be deleted
     */
    @Operation(summary = "Delete a list of Posts", method = "DELETE", description = "The status of the objects is changed to 'Trash'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
